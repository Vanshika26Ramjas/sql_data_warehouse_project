...
FROM (
    ...
    FROM bronze.crm_cust_info   -- ✅ Adjusted for your environment
...
END AS sls_due_dt,
   CASE WHEN sls_sales IS NOT NULL OR sls_sales <=0 OR sls_sales != sls_quantity
